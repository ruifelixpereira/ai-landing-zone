...
# Policies to automate linking Private endpoints to Private DNS Zones
module "private_dns_policies" {
  source = "../../modules/dns-zone-policies"
...
# Policies to automate DNS resolver rules for Private DNS Zones
